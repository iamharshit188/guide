...
const LANGUAGE_META = [
  { file: "lang-c.md",      label: "C",          tag: "C",   badge: "lang-c",   desc: "Systems · Memory · Pointers",    icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6A8.5 8.5 0 1 0 18 18"/></svg>` },
  { file: "lang-cpp.md",    label: "C++",         tag: "C++", badge: "lang-cpp", desc: "OOP · RAII · Templates · STL",   icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M13 8A6 6 0 1 0 13 16"/><line x1="17" y1="10" x2="17" y2="14"/><line x1="15" y1="12" x2="19" y2="12"/><line x1="21" y1="10" x2="21" y2="14"/><line x1="19" y1="12" x2="23" y2="12"/></svg>` },
  { file: "lang-python.md", label: "Python",      tag: "PY",  badge: "lang-py",  desc: "Internals · Async · Decorators", icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3C9 3 7 4.5 7 7v2h5v1H6c-2 0-4 1-4 4s1.5 4 4 4h1v-2c0-2 1.5-3 3-3h6c2 0 3-1 3-3V7c0-2.5-2-4-7-4z"/><path d="M12 21c3 0 5-1.5 5-4v-2h-5v-1h6c2 0 4-1 4-4s-1.5-4-4-4h-1v2c0 2-1.5 3-3 3H8c-2 0-3 1-3 3v3c0 2.5 2 4 7 4z"/><circle cx="9.5" cy="7.5" r="1" fill="currentColor" stroke="none"/><circle cx="14.5" cy="16.5" r="1" fill="currentColor" stroke="none"/></svg>` },
  { file: "lang-js.md",     label: "JavaScript",  tag: "JS",  badge: "lang-js",  desc: "V8 · Event Loop · Promises",     icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="3"/><path d="M15 11v5.5c0 1.5-2.5 1.5-2.5 0"/><path d="M8.5 12.5v4c0 1.5 4 1.5 4 0"/></svg>` },
];
